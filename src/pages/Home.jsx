  ...
  return (
    ...
    >
      <div className="relative flex h-full flex-col items-center px-8 py-20 md:py-35 lg:flex-row-reverse lg:justify-around">
        <svg
          className="mb-12 h-auto max-h-[450px] w-full max-w-[450px]"
        ...
        <div className="relative flex flex-col items-center justify-center">
          <span className="text-accent font-[Poppins] dark:text-accent-dark w-fit text-7xl font-bold tracking-widest uppercase">
            LopCloud
          </span>
